...
public class AStarSearch {
    ...
    public Node aStar(Integer[] board, String heuristic){
        ...
        if(heuristic.equals("misplaced")) //generate frontier based on which heuristic is chosen
    ...
    private static Queue<Node> expandNode(Node parent, String heuristic){ //used to generate the successors of the current node
        ...
        if(parent.isValidMove("u")){ //check if the inputted move does not go out of bounds
            childState = parent.generateState("u"); //get puzzle state generated by given action
            
            if(!Arrays.equals(childState, parent.parent.puzzle)){ //add node to output if the puzzle state does not exist
        ...
        if(parent.isValidMove("d")){
            childState = parent.generateState("d");
            
            if(!Arrays.equals(childState, parent.parent.puzzle)){
        ...
        if(parent.isValidMove("l")){
            childState = parent.generateState("l");
        ...
        if(parent.isValidMove("r")){
            childState = parent.generateState("r");
